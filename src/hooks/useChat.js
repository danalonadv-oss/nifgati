...
function contextResponse(isWork) {
  return isWork
    ? "תאונה בדרך לעבודה פותחת שני מקורות פיצוי נפרדים:\n- חוק פלת\"ד — מול ביטוח החובה של הרכב\n- ביטוח לאומי — תאונת עבודה, ללא קשר לאשם\n\nשתי תביעות, שני תיקים, שתי הכנסות. עורך הדין מנהל את שניהם במקביל."
