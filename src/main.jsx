...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div style={{ fontFamily:"'Heebo',Arial,sans-serif",direction:"rtl",background:"#ffffff",color:"#0a2240",minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",textAlign:"center",padding:24 }}>
          <div>
            ...
            <button onClick={()=>window.location.reload()} style={{ background:"#0a2240",color:"#ffffff",border:"none",borderRadius:12,fontFamily:"inherit",fontWeight:700,fontSize:15,padding:"12px 28px",cursor:"pointer" }}>רענן דף</button>
          </div>
        </div>
      );
    }
