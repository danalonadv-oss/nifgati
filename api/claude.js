...
"זוהי אינדיקציה ראשונית בלבד (החישוב אינו כולל החזר הוצאות רפואיות). כדי להבין איך למצות את הזכויות שלך ולהפוך את המספר הזה למציאות, אני מזמין אותך להמשיך לשיחה קצרה איתי בוואטסאפ. ללא התחייבות, פשוט נבדוק את הפרטים לעומק."
