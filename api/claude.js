...
⚕️ החישוב אינו כולל החזר הוצאות רפואיות.
שכ"ט עו"ד: 8% בפשרה / 13% בפסק דין (לפי סעיף 16 לחוק)

אחרי החישוב הוסף: "לייעוץ מלא ומדויק — ${MY_NAME}, ${MY_TITLE}, מזמין אותך לשיחה חינמית ללא התחייבות. לחץ על הכפתור הירוק למטה לתיאום שיחה."
